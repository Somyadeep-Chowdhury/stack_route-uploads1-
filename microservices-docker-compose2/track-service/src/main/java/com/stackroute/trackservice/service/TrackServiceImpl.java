...
public class TrackServiceImpl implements TrackService
{
    ...
    @Override
    public Track getTrackById(String trackId) throws TrackDoesNotExistException
    {
    ...
    @Override
    public List<Track> searchTracks(String trackName) throws EmptyTrackListException {
        List<Track> searchedTracks = trackRepository.searchTracksByName(trackName);
        if(searchedTracks==null)
            throw new EmptyTrackListException("No Track Found!");
        else
