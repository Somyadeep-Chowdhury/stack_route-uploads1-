...
public class ApplicationContextConfig {
	...
	public DataSource getDataSource() {
		...
		dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");//this is the database driver
	 ...
	 */
		...
		public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) throws IOException {
			...
			sessionFactoryBean.afterPropertiesSet();	//what is afterPropertiesSet?
			return sessionFactoryBean;		// this stores sessions bean
		}
